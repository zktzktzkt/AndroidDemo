...
/**
 * 从相机或者相册取图片辅助类 不带剪裁
 * <p>compile 'com.github.AllenCoder.SuperUtils:mediautil:1.0.5'
...
public class CameraHelper {
    ...
    private static String mAuthority = BuildConfig.APPLICATION_ID + ".fileProvider";
     ...
     */
    public static void openCamera(Activity activity, String authority, String fileName) {
        Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        intent.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
        intent.putExtra(MediaStore.EXTRA_OUTPUT, getOutputPictureUri(activity.getApplicationContext(), authority, fileName));
        activity.startActivityForResult(intent, REQUEST_CAMERA);
    }

    public static void openCamera(Activity activity, String fileName) {
        openCamera(activity, mAuthority, fileName);
    }
