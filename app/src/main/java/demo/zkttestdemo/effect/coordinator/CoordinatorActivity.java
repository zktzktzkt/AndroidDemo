...
public class CoordinatorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new CoordinatorRecyclerAdapter());

        recyclerView2 = (RecyclerView) view2.findViewById(R.id.recycler);
        recyclerView2.setAdapter(new CoordinatorRecyclerAdapter());

        recyclerView3 = (RecyclerView) view3.findViewById(R.id.recycler);
        recyclerView3.setAdapter(new CoordinatorRecyclerAdapter());
