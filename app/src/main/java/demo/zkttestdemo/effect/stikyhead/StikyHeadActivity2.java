 ...
 */
public class StikyHeadActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stiky_head_2);
        ...
        recycler.setAdapter(new BaseQuickAdapter<String, BaseViewHolder>(R.layout.item_recorder, list) {
            ...
            protected void convert(BaseViewHolder helper, String item) {
                LinearLayoutManager linearLayoutManager = new LinearLayoutManager(StikyHeadActivity2.this);
