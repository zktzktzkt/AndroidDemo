...
public class PtrFrameLayout extends ViewGroup {
    ...
    private int showHeaderHideDistance = 0;
    ...
    private void layoutChildren() {
        ...
        if (mHeaderView != null) {
            ...
            final int top = !isShowHeader ? -mHeaderHeight + paddingTop + lp.topMargin + offset + showHeaderHideDistance
                    : -showHeaderHideDistance + paddingTop + lp.topMargin + offset;
        ...
        if (mContent != null) {
            ...
            final int left = paddingLeft + lp.leftMargin;
            final int top = !isShowHeader ? paddingTop + lp.topMargin + offset - showHeaderHideDistance
                    : mHeaderView.getMeasuredHeight() + paddingTop + lp.topMargin + offset - showHeaderHideDistance;
     ...
     * 对露出来的header高度进行微调
     */
    public void setShowHeaderHideDistance(int showHeaderHideDistance) {
        this.showHeaderHideDistance = showHeaderHideDistance;
    }
